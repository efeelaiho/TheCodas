...
class ArtistTestCase(TestCase):
    ...
    def test_albums1(self): 
        ...
        self.assertEqual(a.release_date, datetime.date(1987,9,7))
        self.assertEqual(a.genre, "Pop")
    ...
    def test_albums2(self): 
        ...
        a = Album.objects.create(album_name = "Encore", album_artist = Eminem, release_date = date, genre = "Hip hop", editors_notes = "123")
        self.assertEqual(a.album_name, "Encore")
        self.assertEqual(a.album_artist, Eminem)
        self.assertEqual(a.release_date, datetime.date(2004,11,12))
    ...
    def test_albums3(self): 
        ...
        a = Album.objects.create(album_name = "The College Dropout", album_artist = kanye, release_date = date, genre = "Hip hop", editors_notes = "asdf")
        self.assertEqual(a.album_name, "The College Dropout")
        self.assertEqual(a.album_artist, kanye)
        self.assertEqual(a.release_date, datetime.date(2004,2,10))
        self.assertEqual(a.genre, "Hip hop")
...
class APItests(unittest.TestCase) :
    ...
    def test_get_albums(self) :
        ...
        # self.assertEqual(expected_api, list(api_data))
